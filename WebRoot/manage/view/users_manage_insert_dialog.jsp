<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8"%>
<!-- 新建用户弹窗 start -->
<div id="insertUserDialog" class="easyui-dialog"   data-options="closed:true" style="display: none;width:450px;">
	<form id="insertUserForm" enctype="multipart/form-data" method="post">
		<table id="insertUserTable">
			...
			<tr>
				...
				<td>
					<input id="score" name="score" class="easyui-numberbox input" data-options="prompt:'请输入积分',required:true,min:0,max:999999999,precision:0" style="width:100%"> 
				</td>
			</tr>
			<tr>
				<td>
